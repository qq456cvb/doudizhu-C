...
if __name__ == '__main__':
    ...
    file_writer = tf.summary.FileWriter('accuracy_bugfixed_lr0001_clipped', sess.graph)
    ...
    if TRAIN:
        saver.restore(sess, './Model/accuracy_bugfixed_lr0001_clipped/model.ckpt')
        ...
        for i in range(epoches_train):
            ...
            while r == 0:
                ...
                # TODO: must also train on the length of single and double cards....
                        ...
                        if category_idx == Category.BIGBANG.value:
                            ...
                            if category_idx != Category.EMPTY.value:
                                ...
                                if passive_response_input[0] < 0:
                                    print("Warning")
                                    print(card.Card.to_cards_from_3_17(intention))
                                    print(card.Card.to_cards_from_3_17(last_cards_value))
                else:
                    # ACTIVE OFFSET ONE!
            ...
            if i % 100 == 0:
                ...
                summary = tf.Summary(value=[
                                tf.Summary.Value(tag="Accuracy/passive_decision_accuracy", simple_value=passive_decision_acc), 
                                tf.Summary.Value(tag="Accuracy/passive_response_accuracy", simple_value=passive_response_acc),
                                tf.Summary.Value(tag="Accuracy/passive_bomb_accuracy", simple_value=passive_bomb_acc),
                                tf.Summary.Value(tag="Accuracy/active_decision_accuracy", simple_value=active_decision_acc),
                                tf.Summary.Value(tag="Accuracy/active_response_accuracy", simple_value=active_response_acc),
                                tf.Summary.Value(tag="Accuracy/minor_cards_accuracy", simple_value=minor_cards_acc),
                ...
                # if i % 1000 == 0:
                #     saver.save(sess, "./Model/accuracy_bugfixed_lr0001/model.ckpt")
